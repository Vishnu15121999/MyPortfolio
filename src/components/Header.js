  ...
  return (
    <AppBar position='sticky'>
      <Toolbar sx={{
        ...
        <Typography onClick={handleClick} variant='h5' sx={{
          fontWeight: 'bold', fontFamily: 'cursive',
          color: 'white', fontStyle: 'italic', display: 'flex',
          alignItems: 'center', cursor: 'pointer'
        }}>Vishnu_Portfolio</Typography>
...
//<img className='logo-image' src='https://miro.medium.com/v2/resize:fit:2400/1*yxQO9lRzHPcF8TZAb18y4w.png'/>